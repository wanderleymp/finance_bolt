/*
  # Consolidação do Esquema do Banco de Dados

  1. Objetivo
    - Esta migração consolida o esquema atual do banco de dados
    - Substitui múltiplas migrações fragmentadas por uma única definição clara
    - Serve como ponto de referência para futuras alterações

  2. Tabelas Incluídas
    - Todas as tabelas do esquema público
    - Definições completas com constraints, índices e políticas RLS
*/
...
-- Políticas RLS para planos SaaS
...
-- Políticas RLS para módulos SaaS
...
-- Políticas RLS para associações de planos e módulos
...
-- Políticas RLS para módulos de tenant
...
-- Políticas RLS para assinaturas de tenant
...
-- Políticas RLS para credenciais do sistema
...
-- Políticas RLS para credenciais de tenant
...
-- Políticas RLS para logs de testes de credenciais
...
-- Políticas RLS para provedores de credenciais
...
-- Políticas RLS para configurações de armazenamento
...
-- Políticas RLS para provedores de armazenamento
...
-- Políticas RLS para módulos do sistema
...
-- Políticas RLS para mapeamentos de módulos e armazenamento
