/*
  # Correção de provedores de armazenamento e credenciais

  1. Alterações
    - Remove e recria o provedor Google Drive com configurações corretas
    - Garante que o provedor Google OAuth 2.0 esteja disponível para credenciais
    - Corrige a atualização do provedor Google existente
*/
...
-- Aqui está a correção: não tentamos converter credential_providers para text[]
